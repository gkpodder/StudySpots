...
export default function Favorites() {
  const { places, favorites, isFavorite } = useApp();
  const favoritePlaces = places.filter(place => isFavorite(place.id));
    ...
    <div className="min-h-screen pb-20">
      <header className="bg-white shadow-sm sticky top-0 z-40">
        <div className="px-4 py-4">
          ...
          <p className="text-sm text-gray-600 mt-1">Your saved study places</p>
        </div>
      </header>
      ...
      <main className="px-4 py-6">
        {favoritePlaces.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 mb-6">Start exploring and add places you like!</p>
            <Link
              href="/"
